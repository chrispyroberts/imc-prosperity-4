"""Validates Bot 3 calibration for INTARIAN_PEPPER_ROOT by reprinting metrics table."""
from __future__ import annotations

import json
from pathlib import Path

from calibration.round1.pepper.scripts.analyze_bot3 import analyze, PRODUCT, FV_AND_BOOK
